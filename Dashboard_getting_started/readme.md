...
So we assigned the *text* node to our *Selector* group, gave it a form of 6x2 (width x height) and chose the <br> *label* **value** <br> format, where *label* = Asset: and **value** = Basic. Now rinse and repeat for the other two *text* nodes, but remember to change the **value** to Performance and Eco.
